...
unit-title: "Errors and Uncertainties"
phase: Unknown
subject: "Physics"
...
![Accuracy vs Precision target diagram](./UNI0003_camb_as_physics_m1_l3-img-assets/fig1-page5-img1.png)
*Description: Target diagrams showing different combinations of high/low accuracy and precision.*

It can also be shown on a graph of data as shown below. Each graph colour has a caption in its colour.

![Accuracy vs Precision graph](./UNI0003_camb_as_physics_m1_l3-img-assets/fig2-page6-img1.png)
*Description: Graph showing the distribution of measurements for precise but not accurate, inaccurate and imprecise, accurate and precise, and accurate but not precise results.*
...
ℹ️ How to remember the difference:
...
![Zero error example with feather and ruler](./UNI0003_camb_as_physics_m1_l3-img-assets/fig3-page9-img1.png)
*Description: A diagram showing a feather next to a ruler, where the feather starts at the 1.0 cm mark, not 0 cm, illustrating a zero error.*
...
![Parallax error illustration with ruler](./UNI0003_camb_as_physics_m1_l3-img-assets/fig4-page10-img1.png)
*Description: A diagram showing a ruler with points A, B, and C viewed from different angles, illustrating parallax error.*
...
![Ammeter scale reading](./UNI0003_camb_as_physics_m1_l3-img-assets/fig5-page12-img1.png)
*Description: An ammeter scale reading between 0 and 15 mA.*

*   Absolute uncertainty = Δl = ½ x 0.2 mA = 0.1 mA therefore I = (1.6 ± 0.1) mA
*   Fractional uncertainty = Δl / I = 0.1 / 1.6 = 1/16 therefore I = (1.6 ± 1/16) mA
*   Percentage uncertainty = Δl / I x 100% = 0.1 / 1.6 × 100 = 6.2 % therefore I = (1.6 ± 6.2%) mA
...
ℹ️ Consider the EXAM-STYLE QUESTION below. After reflecting on this question, you would typically reveal the suggested answer.
...
2.  percentage uncertainty = 2 + (3 × 2) or fractional uncertainty = 0.02 + (0.03 × 2)
...
![Tyre diagram](./UNI0003_camb_as_physics_m1_l3-img-assets/fig6-page15-img1.png)
*Description: Diagram showing the inner and outer diameters of a tyre.*
...
**Fractional uncertainty in v:** Δv/v = Δs/s + Δt/t

Δv/v = 0.1/50.0 + 0.05/5.00
Δv/v = 0.002 + 0.01
Δv/v = 0.012
...
**Result:** v = (10.00 ± 0.12) m s⁻¹

You can read a bit more about how to calculate uncertainty [here]([External URL])
...
**Answer:** [Answer text - Not available in source PDF]
**Explanation:** [Explanation text - Not available in source PDF]
...
![Thermometer scale reading](./UNI0003_camb_as_physics_m1_l3-img-assets/fig7-page19-img1.png)
*Description: A close-up of a thermometer scale between 20 and 25 degrees Celsius.*
**Options:**
- 24 °C ± 1 °C
- 24 °C ± 0.1 °C
- 24.0 °C ± 0.2 °C
...
![Celsius thermometer stem showing temperature change](./UNI0003_camb_as_physics_m1_l3-img-assets/fig8-page20-img1.png)
*Description: A Celsius thermometer stem showing an initial temperature below -5°C and a final temperature above +15°C.*
**Options:**
- 14 °C
- 20.5 °C
- 21 °C
