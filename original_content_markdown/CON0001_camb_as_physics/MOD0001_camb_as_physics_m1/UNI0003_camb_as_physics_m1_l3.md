...
![Target diagram showing accuracy and precision](./UNI0003_camb_as_physics_m1_l3-img-assets/fig1-page5-img1.png)
*Description: A 2x2 grid showing target shooting results. The top-left shows shots clustered together near the bullseye (High Accuracy, High Precision). The top-right shows shots spread out around the bullseye (High Accuracy, Low Precision). The bottom-left shows shots clustered together but far from the bullseye (Low Accuracy, High Precision). The bottom-right shows shots spread out far from the bullseye (Low Accuracy, Low Precision).*
...
![Graph showing number of measurements vs value, illustrating accuracy and precision distributions](./UNI0003_camb_as_physics_m1_l3-img-assets/fig2-page6-img1.png)
*Description: A graph with Number of Measurements on the y-axis and Value on the x-axis. Four bell-shaped curves are shown. A red curve is broad and centered away from the true value (Inaccurate, Imprecise). A blue curve is narrow but centered away from the true value (Precise, Not Accurate). A green curve is narrow and centered near the true value (Accurate, Precise). A light blue curve is broad but centered near the true value (Accurate, Not Precise).*
...
![Diagram showing a feather measured with a ruler that has a zero error](./UNI0003_camb_as_physics_m1_l3-img-assets/fig3-page9-img1.png)
*Description: A diagram showing a feather placed next to a ruler. The left end of the feather is at the 1.0 cm mark, and the right end is at the 2.9 cm mark. The ruler is marked in cm and mm.*
...
![Diagram showing parallax error when reading a ruler](./UNI0003_camb_as_physics_m1_l3-img-assets/fig4-page10-img1.png)
*Description: A diagram showing a ruler with marks and a point 'B'. Three eye positions (A, B, C) are shown looking at point B. Position B is directly perpendicular to the ruler at point B, showing the correct reading. Positions A and C are at angles, showing apparent readings slightly off from the correct one due to parallax.*
...
![Diagram of an ammeter scale](./UNI0003_camb_as_physics_m1_l3-img-assets/fig5-page12-img1.png)
*Description: A diagram showing an analog ammeter scale marked from 0 to 15 mA with divisions every 1 mA and subdivisions every 0.2 mA. A needle is pointing to 1.6 mA.*
...
![Diagram of a tyre cross-section showing inner and outer diameters](./UNI0003_camb_as_physics_m1_l3-img-assets/fig6-page13-img1.png)
*Description: A simple cross-section diagram of a tyre, illustrating the outer and inner diameters.*
...
![WEBPAGE: Learn more about calculating uncertainty](https://www.hoddereducation.co.uk/media/documents/physics-uncertainties.pdf)
*Description: This webpage provides additional information on calculating uncertainties.*
*Source: Hodder Education (https://www.hoddereducation.co.uk)*
...
![Diagram of a thermometer scale](./UNI0003_camb_as_physics_m1_l3-img-assets/fig7-page13-img2.png)
*Description: A diagram showing a Celsius thermometer scale marked from 20 to 25 degrees Celsius, with increments of 1 degree and subdivisions every 0.2 degrees. The liquid column reaches slightly below the 24.0 degree mark.*
**Options:**
- 24 °C ± 1 °C
- 24 °C ± 0.1 °C
- 24.0 °C ± 0.2 °C
...
![Diagram of a thermometer stem showing initial and final temperatures](./UNI0003_camb_as_physics_m1_l3-img-assets/fig8-page15-img1.png)
*Description: A diagram showing a Celsius thermometer stem marked from -10 to +15 degrees Celsius in increments of 1 degree, with subdivisions every 0.5 degrees. An arrow labelled "Initial temperature" points to -6 degrees Celsius. An arrow labelled "Final temperature" points to +15 degrees Celsius.*
**Options:**
- 14 °C
- 20.5 °C
- 21 °C
